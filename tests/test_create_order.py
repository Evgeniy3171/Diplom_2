...
class TestCreateOrder:
    ...
    def test_create_order_with_auth_and_valid_ingredients(self, authenticated_user, valid_ingredients):
        api_client = ApiClient(Urls.API_URL)
        
        response = api_client.create_order(valid_ingredients, authenticated_user["access_token"])
    ...
    def test_create_order_without_ingredients(self, authenticated_user):
        ...
        response = api_client.create_order([], authenticated_user["access_token"])
    ...
    def test_create_order_with_invalid_ingredients(self, authenticated_user, invalid_ingredients):
        api_client = ApiClient(Urls.API_URL)
        
        response = api_client.create_order(invalid_ingredients, authenticated_user["access_token"])
    ...
    def test_create_order_with_single_ingredient(self, authenticated_user, get_ingredients):
        api_client = ApiClient(Urls.API_URL)
        
        single_ingredient = [get_ingredients[0]["_id"]]
        response = api_client.create_order(single_ingredient, authenticated_user["access_token"])
